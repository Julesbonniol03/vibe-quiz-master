      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
              ...
              >
                ...
                <div className="relative p-5 flex items-center gap-5">
                  ...
                  <div className={`flex-shrink-0 rounded-2xl flex items-center justify-center font-bold border
                    ${level.id === 15 ? "w-16 h-16 text-2xl" : "w-14 h-14 text-lg"}
                    ${isLocked
                    ...
                    {isLocked ? "🔒" : done ? (level.id === 15 ? "🏆" : "✅") : level.id === 15 ? "⚡" : `J${level.id}`}
                  </div>
        ...
        <div className="mt-6 p-5 rounded-2xl border border-dashed border-white/[0.08] text-center">
          <p className="text-slate-600 text-sm">
            Jours 16-30 bientôt disponibles... Lumières, Révolutions &amp; Ère Moderne 🔥
          </p>
        </div>
          ...
          <div className="rounded-3xl overflow-hidden border border-white/[0.08]">
            ...
            <div className="relative h-48 bg-gradient-to-br from-purple-900/40 to-neon-cyan/20 flex items-center justify-center">
              ...
              <span className="relative text-6xl">
                {selectedLevel.id === 3 ? "🏛️" : selectedLevel.id === 4 ? "💀" : selectedLevel.id === 5 ? "⚔️" : selectedLevel.id === 6 ? "👑" : selectedLevel.id === 7 ? "⛪" : selectedLevel.id === 8 ? "🦠" : selectedLevel.id === 9 ? "🗡️" : selectedLevel.id === 10 ? "📜" : selectedLevel.id === 11 ? "🎨" : selectedLevel.id === 12 ? "🌊" : selectedLevel.id === 13 ? "📌" : selectedLevel.id === 14 ? "⚔️" : selectedLevel.id === 15 ? "⚡" : "🏛️"}
              </span>
            </div>
            ...
            <div className="p-6 bg-white/[0.02]">
              <div className="flex items-center gap-2 mb-3">
                <span className={`text-xs font-bold uppercase tracking-wider px-2 py-1 rounded-full border ${selectedLevel.id === 15 ? "text-yellow-300 bg-yellow-500/10 border-yellow-500/20" : "text-neon-cyan bg-neon-cyan/10 border-neon-cyan/20"}`}>
                  {selectedLevel.id === 15 ? "⚡ BOSS — Jour 15" : `Jour ${selectedLevel.id}`}
                </span>
