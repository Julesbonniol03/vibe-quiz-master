  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <Link
        ...
        style={{ boxShadow: "0 0 20px rgba(168,85,247,0.1), 0 0 40px rgba(168,85,247,0.05)" }}
      >
        ...
        <div className="relative flex items-center gap-4">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-0.5">
              <span className="font-bold text-white text-sm">AVENTURE</span>
            ...
            <p className="text-slate-500 text-xs">De la Préhistoire à l&apos;Ère Numérique — Map S-Curve</p>
          </div>
